...
def background():
  ...
  temp_draw.rectangle((0,0,95,127), fill= (255,255,255))
...
def newImage():
  ...
  if pickImage == 1:
    image = Image.open("./rects_images/octocat-Eva256.jpg").convert('RGB')
  elif pickImage == 2:
    image = Image.open("./rects_images/octocat-Jeff256.jpg").convert('RGB')
  elif pickImage == 3:
    image = Image.open("./rects_images/octocat-Molly256.jpg").convert('RGB')  
  else:
    image = Image.open("./rects_images/octocat-Sam256.jpg").convert('RGB')
  image = image.resize((128,128))
###################################
# ScreenWipe
###################################
